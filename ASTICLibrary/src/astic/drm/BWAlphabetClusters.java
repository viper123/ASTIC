...
public class BWAlphabetClusters {
    ...
    private void addToDb(final String path,final String word,final double initialWeight)
    {
        ...
        pst.setInt(4, (int)initialWeight);
